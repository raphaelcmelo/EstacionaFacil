    ...
    return (
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div className="flex justify-around">
          ...
          <Link href="/check-permit" className={cn(
            "flex flex-col items-center py-2 px-3",
          ...
          <Link href="/quick-buy" className={cn(
            "flex flex-col items-center py-2 px-3",
    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
      <div className="flex justify-around">
        ...
        {(user.role === "FISCAL" || user.role === "ADMIN") && (
          <Link href="/fiscal/verify" className={cn(
            "flex flex-col items-center py-2 px-3",
            (isActive("/fiscal") || isActive("/fiscal/verify")) ? "text-primary" : "text-gray-600"
          )}>
