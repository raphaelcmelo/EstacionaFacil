    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center mb-4">
              <i className="material-icons mr-2">local_parking</i>
              <h2 className="text-lg font-bold">EstacionaFácil</h2>
            </div>
            <p className="text-gray-400 text-sm max-w-xs">
              Sistema oficial de estacionamento rotativo municipal. Facilitando a gestão de vagas públicas com tecnologia.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider mb-3">Ajuda</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Termos de Uso</a></li>
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider mb-3">Baixe o App</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-400">&copy; 2023 Prefeitura Municipal. Todos os direitos reservados.</p>
