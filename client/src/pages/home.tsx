...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>
          EstacionaFácil - Sistema de Estacionamento Rotativo Municipal
        </title>
        <meta
          name="description"
          content="Estacione seu veículo em qualquer vaga rotativa da cidade de forma simples e rápida. Sistema oficial de estacionamento rotativo municipal."
        />
      </Helmet>
          ...
          <div className="md:flex">
            <div className="p-6 md:p-8 md:w-1/2">
              ...
              <p className="text-white opacity-90 mb-6">
                Estacione seu veículo em qualquer vaga rotativa da cidade de
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/check-permit">
                  <Button
                    variant="outline"
                    className="bg-white hover:bg-gray-100 text-primary font-semibold px-5 py-6 h-auto"
                  >
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Digite a placa e modelo do seu veículo.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white font-bold mb-3">
                ...
                <p className="text-gray-600 text-sm">
                  Selecione a duração desejada para estacionar.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white font-bold mb-3">
                ...
                <p className="text-gray-600 text-sm">
                  Utilize seu cartão ou PIX para pagamento.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white font-bold mb-3">
                ...
                <p className="text-gray-600 text-sm">
                  Receba confirmação e estacione sem preocupações.
                </p>
              </div>
            </div>
          </div>
